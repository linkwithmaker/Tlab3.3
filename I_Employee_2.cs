...
{
    public partial class I_Employee_2 : Form
    {
        public I_Employee_2()
        {
        ...
        private void I_Sales_Load(object sender, EventArgs e)
        {
            textBox1.Select();
        }
        ...
        {
            string d = "SELECT * From Employee_2 WHERE ID_Emp = '" + textBox1.Text + "'";
            using (SqlDataAdapter sda = new SqlDataAdapter(d, new SqlConnection(Login.connectString)))
                ...
                else
                {
                    ...
                    if (dt.Rows.Count == 0)
                    {
                        string query = "INSERT INTO Employee_2 VALUES ('" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "','" + textBox5.Text + "')";
        ...
        private void I_Sales_Load_1(object sender, EventArgs e)
        {
        }
    }
}
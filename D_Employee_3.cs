...
{
    public partial class D_Employee_3 : Form
    {
        public D_Employee_3()
        {
        ...
        private void D_Employee_FormClosing(object sender, FormClosingEventArgs e)
        {
            MainForm.a[0] = "";
            MainForm.a[1] = "";
            MainForm.a[2] = "";
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            using (SqlDataAdapter sda = new SqlDataAdapter(d, new SqlConnection(Login.connectString)))
                ...
                else
                {
                    ...
                    if (dt.Rows.Count != 0)
                    {
                        string query = "DELETE FROM Employee_3 WHERE ID_Emp = '" + textBox1.Text + "'";
        ...
        private void D_Employee_Load_1(object sender, EventArgs e)
        {
        }
    }
}
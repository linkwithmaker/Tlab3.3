...
{
    public partial class I_Employee_1 : Form
    {
        public I_Employee_1()
        {
        ...
        private void I_Equipment_Load(object sender, EventArgs e)
        {
            textBox1.Select();
        }
        ...
        {
            string d = "SELECT * From Employee_1 WHERE ID_EMP = '" + textBox1.Text + "'";
            using (SqlDataAdapter sda = new SqlDataAdapter(d, new SqlConnection(Login.connectString)))
                ...
                else
                {
                    ...
                    if (dt.Rows.Count == 0)
                    {
                        string query = "INSERT INTO Employee_1 VALUES ('" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "')";
        ...
        private void I_Equipment_Load_1(object sender, EventArgs e)
        {
        }
    }
}
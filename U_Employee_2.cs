...
{
    public partial class U_Employee_2 : Form
    {
        public U_Employee_2()
        {
        ...
        {
            string d = "SELECT ID_Emp From Sales WHERE ID_Emp = '" + textBox1.Text + "'";
            string d1 = "SELECT ID_Emp From Sales WHERE ID_Emp = '" + textBox2.Text + "'";
            ...
            using (SqlDataAdapter sda1 = new SqlDataAdapter(d1, new SqlConnection(Login.connectString)))
                ...
                else
                {
                    if (textBox1.Text == textBox2.Text)
                    {
                        ...
                        if (dt.Rows.Count != 0)
                        {
                            string query = "UPDATE Sales SET ID_Emp = '" + textBox2.Text + "', Emp_name = '" + textBox3.Text + "', Age = '" + textBox4.Text + "', WorkStartDate = '" + textBox5.Text + "', Office = '" + textBox6.Text + "'  WHERE ID_Emp = '" + textBox1.Text + "'";
                    ...
                    else
                    {
                        ...
                        if (dt1.Rows.Count == 0)
                        {
                            ...
                            if (dt.Rows.Count != 0)
                            {
                                string query = "UPDATE Sales SET ID_Emp = '" + textBox2.Text + "', Emp_name = '" + textBox3.Text + "', Age = '" + textBox4.Text + "', WorkStartDate = '" + textBox5.Text + "', Office = '" + textBox6.Text + "'";
                                SqlConnection sql_conn = new SqlConnection(Login.connectString);
                                SqlCommand sql_comm = new SqlCommand(query, sql_conn);
                                sql_conn.Open();
                                sql_comm.ExecuteNonQuery();
        ...
        private void U_Sales_Load_1(object sender, EventArgs e)
        {
            textBox1.Select();
        ...
        private void U_Sales_FormClosing_1(object sender, FormClosingEventArgs e)
        {
            MainForm.a[0] = "";
            MainForm.a[1] = "";
            MainForm.a[2] = "";
